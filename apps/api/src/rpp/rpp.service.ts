    ...
    async create(guruId: string, createRppDto: CreateRppDto) {
        ...
        const rpp = await this.prisma.rPP.create({
            data: {
                ...
                kegiatanAwal: rppData.kegiatanAwal ? (rppData.kegiatanAwal as Prisma.InputJsonValue) : Prisma.DbNull,
                kegiatanMemahami: rppData.kegiatanMemahami ? (rppData.kegiatanMemahami as Prisma.InputJsonValue) : Prisma.DbNull,
                kegiatanMengaplikasi: rppData.kegiatanMengaplikasi ? (rppData.kegiatanMengaplikasi as Prisma.InputJsonValue) : Prisma.DbNull,
                kegiatanMerefleksi: rppData.kegiatanMerefleksi ? (rppData.kegiatanMerefleksi as Prisma.InputJsonValue) : Prisma.DbNull,
                kegiatanPenutup: rppData.kegiatanPenutup ? (rppData.kegiatanPenutup as Prisma.InputJsonValue) : Prisma.DbNull,
            },
            include: {
                mataPelajaran: true,
                guru: true,
